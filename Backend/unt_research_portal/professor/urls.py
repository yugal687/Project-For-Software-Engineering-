...
# from .views import ProfessorListView, ProfessorDetailView, ResearchOpportunityListView, ResearchOpportunityDetailView

# urlpatterns = [
#     path('professors/', ProfessorListView.as_view(), name='professor-list'),
#     path('professors/<int:id>/', ProfessorDetailView.as_view(), name='professor-detail'),
#     path('research-opportunities/', ResearchOpportunityListView.as_view(), name='research-opportunity-list'),
#     path('research-opportunities/<int:id>/', ResearchOpportunityDetailView.as_view(), name='research-opportunity-detail'),
# ]


from django.urls import path, include
from rest_framework.routers import DefaultRouter
from .views import ProfessorViewSet, ResearchOpportunityViewSet
